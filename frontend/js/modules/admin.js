  ...
  view.settings = function (c) {
    ...
    var f = {
      ...
      openRegistration: (function () {
        ...
        var l = m('label', opts, [ f, A.FIELD.OPEN_REGISTRATION, icon ]);
        return l;
      })(),
      authMethod: (function() {
        var icon = m('i', {
    ...
    return m('form', {
      ...
      m('fieldset', [
        ...
        m('div', [
          ...
          m('div.form-group', (c.data.authMethod() !== 'ldap') ? { class: 'hidden' } : undefined,[ f.authLdapSettings.label, f.authLdapSettings.help, f.authLdapSettings.textarea ]),
        ])
      ]),
      m('fieldset', [
