  ...
  user.view.field.useLoginAndColorInPads = function (c) {
    return {
      label: m('label', [
        ...
        ((conf.SERVER.useDisplayNameInPads) ? conf.LANG.USER.USECOLORINPADS : conf.LANG.USER.USELOGINANDCOLORINPADS),
        m('i',{
          class: 'mp-tooltip glyphicon glyphicon-info-sign',
          'data-msg': ((conf.SERVER.useDisplayNameInPads) ? conf.LANG.USER.INFO.USECOLORINPADS : conf.LANG.USER.INFO.USELOGINANDCOLORINPADS)
        }),
      ]),
    };
  };
