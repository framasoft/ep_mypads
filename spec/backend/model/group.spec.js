...
(function () {
  ...
  describe('group', function () {
    ...
    describe('group inviteOrShare', function () {
      ...
      it('should return the updated group and an object containing present ' +
        ' and absent logins or emails otherwise', function (done) {
          ...
          group.inviteOrShare(true, gparams._id, users,
            function (err, res, uids) {
              ...
              expect(ld.size(uids.present)).toBe(2);
              expect(ld.size(uids.absent)).toBe(1);
              expect(uids.absent[0]).toBe('inexist');
              ...
              group.inviteOrShare(false, gparams._id, admins,
                function (err, res, uids) {
                  ...
                  expect(ld.size(uids.present)).toBe(1);
                  expect(uids.present[0]).toBe('grace');
                  expect(ld.size(uids.absent)).toBe(2);
                  done();
                }
              );
            }
